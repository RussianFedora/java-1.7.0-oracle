...
U=79
B=15
curl -sLJO -H "Cookie: $COOKIE" http://download.oracle.com/otn-pub/java/jdk/7u$U-b$B/jdk-7u$U-linux-x64.tar.gz
curl -sLJO -H "Cookie: $COOKIE" http://download.oracle.com/otn-pub/java/jdk/7u$U-b$B/jdk-7u$U-linux-i586.tar.gz
